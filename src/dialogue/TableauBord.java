...
public class TableauBord extends JDialog {
    ...
    private void initialize() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(getClass()
                .getResource("/images/gestion/logoNetBeans.png")));
        setTitle("SARL XELFI");
    }
    ...
    private JLabel getJLab_Camembert() {
        if (JLab_Camembert == null) {
            ...
            JLab_Camembert.setIcon(new ImageIcon(TableauBord.class
                    .getResource("/images/gestion/chart.png")));
    ...
    private JLabel getJLab_Nombre() {
        if (JLab_Nombre == null) {
            ...
            JLab_Nombre.setIcon(new ImageIcon(TableauBord.class
                    .getResource("/images/gestion/commande1.png")));
    ...
    private JLabel getLblCa() {
        if (lblCa == null) {
            lblCa = new JLabel("CA");
            lblCa.setIcon(new ImageIcon(TableauBord.class.getResource("/images/gestion/tableauBord.png")));
    ...
    private JLabel getLblImpays() {
        if (lblImpays == null) {
            ...
            lblImpays.setIcon(new ImageIcon(TableauBord.class.getResource("/images/gestion/client2.png")));
